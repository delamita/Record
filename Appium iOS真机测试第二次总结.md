...
3. Appium的插件安装
 ...
 `appium-doctor --ios`  
 appium-doctor检测结果如下
 ![https://github.com/delamita/Record/blob/master/.resources/2.png]()
...
![https://github.com/delamita/Record/blob/master/.resources/3.png]()
还有WebdriverAgentRunner的签名，可能会签名失败，这个时候选到Build Settings里的packing选项卡的Product Bundle Indentifier，修改原来的com.facebook.wda.lib就可以了。修改完成后scheme选择WebDriveAgentRunner，输出选择自己的真机，然后运行test，可以直接cmd+U来运行test。（或者长按运行的按钮在下拉里有test选项，第一次运行真机需要在设置里授权。）
   ...
   ![https://github.com/delamita/Record/blob/master/.resources/8.png]()
   这个时候去浏览器输入所提示的ServerURL，会打开一串JSON，如图。
   ![https://github.com/delamita/Record/blob/master/.resources/1.png]()
...
![https://github.com/delamita/Record/blob/master/.resources/5.png]()
...
![https://github.com/delamita/Record/blob/master/.resources/7.png]()
